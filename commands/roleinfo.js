...
module.exports.run = async (bot, message, args) => {
  ...
  message.delete()
  message.channel.send(embed3).then(message.channel.send(embed7).then(message.channel.send(embed4).then(message.channel.send(embedwp).then(message.channel.send(embed7).then(message.channel.send(verifyiteoms))))))
}
